...
', 
                       ...
                       'Seu programa deve produzir uma única linha com nove inteiros representando os números de lombadas que devem ser contadas para garantir o cumprimento, respectivamente, de 10%, 20%, : : : , 90% da meta.');-- insert into exemplo (atv_id, exe_entrada, exe_saida)
...
insert into exemplo (atv_id, exe_entrada, exe_saida)
           values (4, 'hahaha', 'S');
insert into exemplo (atv_id, exe_entrada, exe_saida)
           values (4, 'riajkjdhhihhjak', 'N');
insert into exemplo (atv_id, exe_entrada, exe_saida)
           values (4, 'a', 'S');
insert into exemplo (atv_id, exe_entrada, exe_saida)
           values (4, 'huaauhahhuahau', 'S');
-- atividade 5 **********************************************
insert into exemplo (atv_id, exe_entrada, exe_saida)
           values (5, '5 3
0 0 0
...
-- atividade 9 **********************************************
insert into exemplo (atv_id, exe_entrada, exe_saida)
           values (9, 'FDMLCRDMRALF
ARMADA', '2');
insert into exemplo (atv_id, exe_entrada, exe_saida)
           values (9, 'AAAAABABABABABABABABA
ABA', '7');
-- atividade 10 **********************************************
insert into exemplo (atv_id, exe_entrada, exe_saida)
           values (10, '3 17', '6 11 16 21 26 31 36 41 46');
insert into exemplo (atv_id, exe_entrada, exe_saida)
           values (10, '5 17', '9 17 26 34 43 51 60 68 77');
insert into exemplo (atv_id, exe_entrada, exe_saida)
           values (10, '3 11', '4 7 10 14 17 20 24 27 30');