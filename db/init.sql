...
insert into atividade (id, titulo, descricao, entrada, saida) 
               values (1, 'X do Guedes', 'Em 2012 foi alcançado um novo recorde mundial na famosa Competição de Cachorros-Quentes do Nathan: o campeão, Joey Chestnut, devorou 68 cachorros-quentes em dez minutos, um aumento incrível em relação aos 62 sanduíches devorados pelo mesmo Chestnut em 2011.
...
insert into atividade (id, titulo, descricao, entrada, saida) 
               values (2, 'Fatorando', 'O fatorial de um número inteiro positivo N, denotado por N!, é definido como o produto dos inteiros positivos menores do que ou iguais a N. Por exemplo 4! = 4 × 3 × 2 × 1 = 24.
